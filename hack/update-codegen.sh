...
function generate_client() {
  ...
  echo "${ROOT_DIR}/pkg/apis/${CUSTOM_RESOURCE_NAME}"
  find "${ROOT_DIR}/pkg/apis/${CUSTOM_RESOURCE_NAME}" -type f -exec bash -c "sed -i.bak 's/smi-spec.io/smispec.io/g' {} && rm {}.bak" ";"
  ...
  # generation.
  find "${ROOT_DIR}/pkg/apis/${CUSTOM_RESOURCE_NAME}" -type f -exec bash -c "sed -i.bak 's/smispec.io/smi-spec.io/g' {} && rm {}.bak" ";"
  find "${ROOT_DIR}/pkg/gen/client/${CUSTOM_RESOURCE_NAME}" -type f -exec bash -c "sed -i.bak 's/smispec.io/smi-spec.io/g' {} && rm {}.bak" ";"
}
