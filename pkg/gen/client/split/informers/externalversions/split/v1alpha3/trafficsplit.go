...
import (
	...
	v1alpha3 "github.com/servicemeshinterface/smi-sdk-go/pkg/gen/client/split/listers/split/v1alpha3"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SplitV1alpha3().TrafficSplits(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SplitV1alpha3().TrafficSplits(namespace).Watch(options)
			},
		},
		&splitv1alpha3.TrafficSplit{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficSplitInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&splitv1alpha3.TrafficSplit{}, f.defaultInformer)
}
