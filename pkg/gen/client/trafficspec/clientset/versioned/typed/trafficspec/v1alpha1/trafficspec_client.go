...
func (c *SmispecV1alpha1Client) HTTPRouteses(namespace string) HTTPRoutesInterface {
...
func (c *SmispecV1alpha1Client) TCPRoutes(namespace string) TCPRouteInterface {
	return newTCPRoutes(c, namespace)
}

func (c *SmispecV1alpha1Client) TrafficTargets(namespace string) TrafficTargetInterface {
