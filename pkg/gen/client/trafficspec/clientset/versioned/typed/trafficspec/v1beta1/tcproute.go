...
type TCPRouteInterface interface {
	Create(*v1beta1.TCPRoute) (*v1beta1.TCPRoute, error)
	Update(*v1beta1.TCPRoute) (*v1beta1.TCPRoute, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.TCPRoute, error)
	List(opts v1.ListOptions) (*v1beta1.TCPRouteList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TCPRoute, err error)
	TCPRouteExpansion
}
...
func newTCPRoutes(c *SmispecV1beta1Client, namespace string) *tCPRoutes {
	return &tCPRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tCPRoutes) Get(name string, options v1.GetOptions) (result *v1beta1.TCPRoute, err error) {
...
func (c *tCPRoutes) List(opts v1.ListOptions) (result *v1beta1.TCPRouteList, err error) {
...
func (c *tCPRoutes) Create(tCPRoute *v1beta1.TCPRoute) (result *v1beta1.TCPRoute, err error) {
	result = &v1beta1.TCPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Update(tCPRoute *v1beta1.TCPRoute) (result *v1beta1.TCPRoute, err error) {
	result = &v1beta1.TCPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TCPRoute, err error) {
	result = &v1beta1.TCPRoute{}
