...
type TrafficTargetInterface interface {
	Create(*v1beta1.TrafficTarget) (*v1beta1.TrafficTarget, error)
	Update(*v1beta1.TrafficTarget) (*v1beta1.TrafficTarget, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.TrafficTarget, error)
	List(opts v1.ListOptions) (*v1beta1.TrafficTargetList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TrafficTarget, err error)
...
func newTrafficTargets(c *SmispecV1beta1Client, namespace string) *trafficTargets {
...
func (c *trafficTargets) Get(name string, options v1.GetOptions) (result *v1beta1.TrafficTarget, err error) {
	result = &v1beta1.TrafficTarget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *trafficTargets) List(opts v1.ListOptions) (result *v1beta1.TrafficTargetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.TrafficTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Create(trafficTarget *v1beta1.TrafficTarget) (result *v1beta1.TrafficTarget, err error) {
	result = &v1beta1.TrafficTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Update(trafficTarget *v1beta1.TrafficTarget) (result *v1beta1.TrafficTarget, err error) {
	result = &v1beta1.TrafficTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.TrafficTarget, err error) {
	result = &v1beta1.TrafficTarget{}
