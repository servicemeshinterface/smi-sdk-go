	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SmispecV1alpha1().TrafficTargets(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SmispecV1alpha1().TrafficTargets(namespace).Watch(options)
			},
		},
		&trafficspecv1alpha1.TrafficTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trafficspecv1alpha1.TrafficTarget{}, f.defaultInformer)
}
