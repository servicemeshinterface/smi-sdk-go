	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SmispecV1beta1().TCPRoutes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SmispecV1beta1().TCPRoutes(namespace).Watch(options)
			},
		},
		&trafficspecv1beta1.TCPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tCPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trafficspecv1beta1.TCPRoute{}, f.defaultInformer)
}

func (f *tCPRouteInformer) Lister() v1beta1.TCPRouteLister {
	return v1beta1.NewTCPRouteLister(f.Informer().GetIndexer())
}
