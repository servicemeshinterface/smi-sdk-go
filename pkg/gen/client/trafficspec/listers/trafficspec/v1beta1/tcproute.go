...
type TCPRouteLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.TCPRoute, err error)
...
// List lists all TCPRoutes in the indexer.
func (s *tCPRouteLister) List(selector labels.Selector) (ret []*v1beta1.TCPRoute, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.TCPRoute))
	})
	return ret, err
}
...
type TCPRouteNamespaceLister interface {
	...
	Get(name string) (*v1beta1.TCPRoute, error)
...
// List lists all TCPRoutes in the indexer for a given namespace.
func (s tCPRouteNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.TCPRoute, err error) {
...
// Get retrieves the TCPRoute from the indexer for a given namespace and name.
func (s tCPRouteNamespaceLister) Get(name string) (*v1beta1.TCPRoute, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("tcproute"), name)
	}
	return obj.(*v1beta1.TCPRoute), nil
}
