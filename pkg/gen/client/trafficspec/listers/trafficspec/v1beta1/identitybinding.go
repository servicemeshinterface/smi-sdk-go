...
type IdentityBindingLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.IdentityBinding, err error)
...
// List lists all IdentityBindings in the indexer.
func (s *identityBindingLister) List(selector labels.Selector) (ret []*v1beta1.IdentityBinding, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.IdentityBinding))
	})
	return ret, err
}
...
type IdentityBindingNamespaceLister interface {
	...
	Get(name string) (*v1beta1.IdentityBinding, error)
...
// List lists all IdentityBindings in the indexer for a given namespace.
func (s identityBindingNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.IdentityBinding, err error) {
...
// Get retrieves the IdentityBinding from the indexer for a given namespace and name.
func (s identityBindingNamespaceLister) Get(name string) (*v1beta1.IdentityBinding, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("identitybinding"), name)
	}
	return obj.(*v1beta1.IdentityBinding), nil
}
