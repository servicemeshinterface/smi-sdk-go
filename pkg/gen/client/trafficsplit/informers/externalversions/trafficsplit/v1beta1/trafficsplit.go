...
import (
	...
	trafficsplitv1beta1 "github.com/deislabs/smi-sdk-go/pkg/apis/trafficsplit/v1beta1"
	versioned "github.com/deislabs/smi-sdk-go/pkg/gen/client/trafficsplit/clientset/versioned"
	internalinterfaces "github.com/deislabs/smi-sdk-go/pkg/gen/client/trafficsplit/informers/externalversions/internalinterfaces"
	v1beta1 "github.com/deislabs/smi-sdk-go/pkg/gen/client/trafficsplit/listers/trafficsplit/v1beta1"
...
type TrafficSplitInformer interface {
	...
	Lister() v1beta1.TrafficSplitLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SmispecV1beta1().TrafficSplits(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SmispecV1beta1().TrafficSplits(namespace).Watch(options)
			},
		},
		&trafficsplitv1beta1.TrafficSplit{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficSplitInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trafficsplitv1beta1.TrafficSplit{}, f.defaultInformer)
}

func (f *trafficSplitInformer) Lister() v1beta1.TrafficSplitLister {
	return v1beta1.NewTrafficSplitLister(f.Informer().GetIndexer())
}
