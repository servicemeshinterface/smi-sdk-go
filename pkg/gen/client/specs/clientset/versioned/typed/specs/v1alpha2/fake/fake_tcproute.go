...
var tcproutesResource = schema.GroupVersionResource{Group: "specs.smi-spec.io", Version: "v1alpha2", Resource: "tcproutes"}

var tcproutesKind = schema.GroupVersionKind{Group: "specs.smi-spec.io", Version: "v1alpha2", Kind: "TCPRoute"}

// Get takes name of the tCPRoute, and returns the corresponding tCPRoute object, and an error if there is any.
func (c *FakeTCPRoutes) Get(name string, options v1.GetOptions) (result *v1alpha2.TCPRoute, err error) {
	obj, err := c.Fake.
...
func (c *FakeTCPRoutes) List(opts v1.ListOptions) (result *v1alpha2.TCPRouteList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTCPRoutes) Create(tCPRoute *v1alpha2.TCPRoute) (result *v1alpha2.TCPRoute, err error) {
	obj, err := c.Fake.
...
func (c *FakeTCPRoutes) Update(tCPRoute *v1alpha2.TCPRoute) (result *v1alpha2.TCPRoute, err error) {
	obj, err := c.Fake.
...
func (c *FakeTCPRoutes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.TCPRoute, err error) {
	obj, err := c.Fake.
