...
func (c *FakeHTTPRouteGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeHTTPRouteGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HTTPRouteGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeHTTPRouteGroups) Create(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.CreateOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeHTTPRouteGroups) Update(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.UpdateOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeHTTPRouteGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HTTPRouteGroup, err error) {
	obj, err := c.Fake.
