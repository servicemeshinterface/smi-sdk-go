...
var udproutesResource = schema.GroupVersionResource{Group: "specs.smi-spec.io", Version: "v1alpha4", Resource: "udproutes"}

var udproutesKind = schema.GroupVersionKind{Group: "specs.smi-spec.io", Version: "v1alpha4", Kind: "UDPRoute"}
...
func (c *FakeUDPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.UDPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(udproutesResource, c.ns, name), &v1alpha4.UDPRoute{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha4.UDPRoute), err
}
...
func (c *FakeUDPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.UDPRouteList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(udproutesResource, udproutesKind, c.ns, opts), &v1alpha4.UDPRouteList{})
	...
	list := &v1alpha4.UDPRouteList{ListMeta: obj.(*v1alpha4.UDPRouteList).ListMeta}
	for _, item := range obj.(*v1alpha4.UDPRouteList).Items {
...
func (c *FakeUDPRoutes) Create(ctx context.Context, uDPRoute *v1alpha4.UDPRoute, opts v1.CreateOptions) (result *v1alpha4.UDPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(udproutesResource, c.ns, uDPRoute), &v1alpha4.UDPRoute{})
...
func (c *FakeUDPRoutes) Update(ctx context.Context, uDPRoute *v1alpha4.UDPRoute, opts v1.UpdateOptions) (result *v1alpha4.UDPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(udproutesResource, c.ns, uDPRoute), &v1alpha4.UDPRoute{})
...
func (c *FakeUDPRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(udproutesResource, c.ns, name), &v1alpha4.UDPRoute{})
...
func (c *FakeUDPRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha4.UDPRouteList{})
	return err
}
...
func (c *FakeUDPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.UDPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(udproutesResource, c.ns, name, pt, data, subresources...), &v1alpha4.UDPRoute{})
