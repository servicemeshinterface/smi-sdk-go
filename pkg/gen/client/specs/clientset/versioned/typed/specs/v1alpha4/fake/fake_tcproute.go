...
var tcproutesResource = schema.GroupVersionResource{Group: "specs.smi-spec.io", Version: "v1alpha4", Resource: "tcproutes"}

var tcproutesKind = schema.GroupVersionKind{Group: "specs.smi-spec.io", Version: "v1alpha4", Kind: "TCPRoute"}
...
func (c *FakeTCPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.TCPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tcproutesResource, c.ns, name), &v1alpha4.TCPRoute{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha4.TCPRoute), err
}
...
func (c *FakeTCPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.TCPRouteList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tcproutesResource, tcproutesKind, c.ns, opts), &v1alpha4.TCPRouteList{})
	...
	list := &v1alpha4.TCPRouteList{ListMeta: obj.(*v1alpha4.TCPRouteList).ListMeta}
	for _, item := range obj.(*v1alpha4.TCPRouteList).Items {
...
func (c *FakeTCPRoutes) Create(ctx context.Context, tCPRoute *v1alpha4.TCPRoute, opts v1.CreateOptions) (result *v1alpha4.TCPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tcproutesResource, c.ns, tCPRoute), &v1alpha4.TCPRoute{})
...
func (c *FakeTCPRoutes) Update(ctx context.Context, tCPRoute *v1alpha4.TCPRoute, opts v1.UpdateOptions) (result *v1alpha4.TCPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tcproutesResource, c.ns, tCPRoute), &v1alpha4.TCPRoute{})
...
func (c *FakeTCPRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(tcproutesResource, c.ns, name), &v1alpha4.TCPRoute{})
...
func (c *FakeTCPRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha4.TCPRouteList{})
	return err
}
...
func (c *FakeTCPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.TCPRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tcproutesResource, c.ns, name, pt, data, subresources...), &v1alpha4.TCPRoute{})
