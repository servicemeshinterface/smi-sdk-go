...
type HTTPRouteGroupInterface interface {
	Create(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.CreateOptions) (*v1alpha1.HTTPRouteGroup, error)
	Update(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.UpdateOptions) (*v1alpha1.HTTPRouteGroup, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.HTTPRouteGroup, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.HTTPRouteGroupList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HTTPRouteGroup, err error)
...
func newHTTPRouteGroups(c *SpecsV1alpha1Client, namespace string) *hTTPRouteGroups {
...
func (c *hTTPRouteGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
...
func (c *hTTPRouteGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HTTPRouteGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HTTPRouteGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("httproutegroups").
...
func (c *hTTPRouteGroups) Create(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.CreateOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
	result = &v1alpha1.HTTPRouteGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("httproutegroups").
...
func (c *hTTPRouteGroups) Update(ctx context.Context, hTTPRouteGroup *v1alpha1.HTTPRouteGroup, opts v1.UpdateOptions) (result *v1alpha1.HTTPRouteGroup, err error) {
	result = &v1alpha1.HTTPRouteGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("httproutegroups").
...
func (c *hTTPRouteGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HTTPRouteGroup, err error) {
	result = &v1alpha1.HTTPRouteGroup{}
