...
type TCPRouteInterface interface {
	Create(ctx context.Context, tCPRoute *v1alpha3.TCPRoute, opts v1.CreateOptions) (*v1alpha3.TCPRoute, error)
	Update(ctx context.Context, tCPRoute *v1alpha3.TCPRoute, opts v1.UpdateOptions) (*v1alpha3.TCPRoute, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.TCPRoute, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.TCPRouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.TCPRoute, err error)
	TCPRouteExpansion
}
...
func newTCPRoutes(c *SpecsV1alpha3Client, namespace string) *tCPRoutes {
	return &tCPRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tCPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.TCPRoute, err error) {
	result = &v1alpha3.TCPRoute{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tcproutes").
		Name(name).
...
func (c *tCPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.TCPRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.TCPRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Create(ctx context.Context, tCPRoute *v1alpha3.TCPRoute, opts v1.CreateOptions) (result *v1alpha3.TCPRoute, err error) {
	result = &v1alpha3.TCPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Update(ctx context.Context, tCPRoute *v1alpha3.TCPRoute, opts v1.UpdateOptions) (result *v1alpha3.TCPRoute, err error) {
	result = &v1alpha3.TCPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.TCPRoute, err error) {
	result = &v1alpha3.TCPRoute{}
