...
func newTCPRoutes(c *SpecsV1alpha4Client, namespace string) *tCPRoutes {
	return &tCPRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *tCPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.TCPRoute, err error) {
	result = &v1alpha4.TCPRoute{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tcproutes").
		Name(name).
...
func (c *tCPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.TCPRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha4.TCPRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Create(ctx context.Context, tCPRoute *v1alpha4.TCPRoute, opts v1.CreateOptions) (result *v1alpha4.TCPRoute, err error) {
	result = &v1alpha4.TCPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Update(ctx context.Context, tCPRoute *v1alpha4.TCPRoute, opts v1.UpdateOptions) (result *v1alpha4.TCPRoute, err error) {
	result = &v1alpha4.TCPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("tcproutes").
...
func (c *tCPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.TCPRoute, err error) {
	result = &v1alpha4.TCPRoute{}
