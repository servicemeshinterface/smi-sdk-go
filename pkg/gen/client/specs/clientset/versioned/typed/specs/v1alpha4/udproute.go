...
func newUDPRoutes(c *SpecsV1alpha4Client, namespace string) *uDPRoutes {
	return &uDPRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *uDPRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.UDPRoute, err error) {
	result = &v1alpha4.UDPRoute{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("udproutes").
		Name(name).
...
func (c *uDPRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.UDPRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha4.UDPRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("udproutes").
...
func (c *uDPRoutes) Create(ctx context.Context, uDPRoute *v1alpha4.UDPRoute, opts v1.CreateOptions) (result *v1alpha4.UDPRoute, err error) {
	result = &v1alpha4.UDPRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("udproutes").
...
func (c *uDPRoutes) Update(ctx context.Context, uDPRoute *v1alpha4.UDPRoute, opts v1.UpdateOptions) (result *v1alpha4.UDPRoute, err error) {
	result = &v1alpha4.UDPRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("udproutes").
...
func (c *uDPRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.UDPRoute, err error) {
	result = &v1alpha4.UDPRoute{}
