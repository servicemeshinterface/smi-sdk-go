...
import (
	...
	v1alpha2 "github.com/deislabs/smi-sdk-go/pkg/gen/client/specs/listers/specs/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpecsV1alpha2().TCPRoutes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpecsV1alpha2().TCPRoutes(namespace).Watch(options)
			},
		},
		&specsv1alpha2.TCPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tCPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&specsv1alpha2.TCPRoute{}, f.defaultInformer)
}
