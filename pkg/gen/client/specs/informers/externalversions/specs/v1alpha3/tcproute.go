...
type TCPRouteInformer interface {
	...
	Lister() v1alpha3.TCPRouteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpecsV1alpha3().TCPRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpecsV1alpha3().TCPRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&specsv1alpha3.TCPRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tCPRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&specsv1alpha3.TCPRoute{}, f.defaultInformer)
}

func (f *tCPRouteInformer) Lister() v1alpha3.TCPRouteLister {
	return v1alpha3.NewTCPRouteLister(f.Informer().GetIndexer())
}
