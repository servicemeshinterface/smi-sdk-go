...
import (
	...
	versioned "github.com/deislabs/smi-sdk-go/pkg/gen/client/specs/clientset/versioned"
	internalinterfaces "github.com/deislabs/smi-sdk-go/pkg/gen/client/specs/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/deislabs/smi-sdk-go/pkg/gen/client/specs/listers/specs/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SpecsV1alpha1().HTTPRouteGroups(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SpecsV1alpha1().HTTPRouteGroups(namespace).Watch(options)
			},
		},
		&specsv1alpha1.HTTPRouteGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hTTPRouteGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&specsv1alpha1.HTTPRouteGroup{}, f.defaultInformer)
}
