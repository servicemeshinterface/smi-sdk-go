...
type TrafficMetricsLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.TrafficMetrics, err error)
...
// List lists all TrafficMetricses in the indexer.
func (s *trafficMetricsLister) List(selector labels.Selector) (ret []*v1alpha2.TrafficMetrics, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.TrafficMetrics))
	})
	return ret, err
}
...
type TrafficMetricsNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.TrafficMetrics, error)
...
// List lists all TrafficMetricses in the indexer for a given namespace.
func (s trafficMetricsNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.TrafficMetrics, err error) {
...
// Get retrieves the TrafficMetrics from the indexer for a given namespace and name.
func (s trafficMetricsNamespaceLister) Get(name string) (*v1alpha2.TrafficMetrics, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("trafficmetrics"), name)
	}
	return obj.(*v1alpha2.TrafficMetrics), nil
}
