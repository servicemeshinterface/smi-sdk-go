...
func (c *FakeTrafficMetricses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.TrafficMetrics, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrafficMetricses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.TrafficMetricsList, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrafficMetricses) Create(ctx context.Context, trafficMetrics *v1alpha2.TrafficMetrics, opts v1.CreateOptions) (result *v1alpha2.TrafficMetrics, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrafficMetricses) Update(ctx context.Context, trafficMetrics *v1alpha2.TrafficMetrics, opts v1.UpdateOptions) (result *v1alpha2.TrafficMetrics, err error) {
	obj, err := c.Fake.
...
func (c *FakeTrafficMetricses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.TrafficMetrics, err error) {
	obj, err := c.Fake.
