...
// MetricsV1alpha1Client is used to interact with features provided by the metrics.smi-spec.io group.
type MetricsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MetricsV1alpha1Client) TrafficMetricses(namespace string) TrafficMetricsInterface {
