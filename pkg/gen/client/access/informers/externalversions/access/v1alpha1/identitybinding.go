	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AccessV1alpha1().IdentityBindings(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AccessV1alpha1().IdentityBindings(namespace).Watch(options)
			},
		},
		&accessv1alpha1.IdentityBinding{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *identityBindingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&accessv1alpha1.IdentityBinding{}, f.defaultInformer)
}
