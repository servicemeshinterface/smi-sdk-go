...
import (
	...
	v1alpha1 "github.com/servicemeshinterface/smi-sdk-go/pkg/gen/client/access/listers/access/v1alpha1"
...
func (f *trafficTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&accessv1alpha1.TrafficTarget{}, f.defaultInformer)
}
