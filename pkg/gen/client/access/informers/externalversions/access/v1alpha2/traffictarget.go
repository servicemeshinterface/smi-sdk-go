...
import (
	...
	v1alpha2 "github.com/servicemeshinterface/smi-sdk-go/pkg/gen/client/access/listers/access/v1alpha2"
...
type TrafficTargetInformer interface {
	...
	Lister() v1alpha2.TrafficTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AccessV1alpha2().TrafficTargets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AccessV1alpha2().TrafficTargets(namespace).Watch(context.TODO(), options)
			},
		},
		&accessv1alpha2.TrafficTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&accessv1alpha2.TrafficTarget{}, f.defaultInformer)
}

func (f *trafficTargetInformer) Lister() v1alpha2.TrafficTargetLister {
	return v1alpha2.NewTrafficTargetLister(f.Informer().GetIndexer())
}
