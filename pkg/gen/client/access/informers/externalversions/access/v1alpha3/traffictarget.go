...
import (
	...
	versioned "github.com/servicemeshinterface/smi-sdk-go/pkg/gen/client/access/clientset/versioned"
	...
	v1alpha3 "github.com/servicemeshinterface/smi-sdk-go/pkg/gen/client/access/listers/access/v1alpha3"
...
type TrafficTargetInformer interface {
	...
	Lister() v1alpha3.TrafficTargetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AccessV1alpha3().TrafficTargets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AccessV1alpha3().TrafficTargets(namespace).Watch(context.TODO(), options)
			},
		},
		&accessv1alpha3.TrafficTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *trafficTargetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&accessv1alpha3.TrafficTarget{}, f.defaultInformer)
}

func (f *trafficTargetInformer) Lister() v1alpha3.TrafficTargetLister {
	return v1alpha3.NewTrafficTargetLister(f.Informer().GetIndexer())
}
