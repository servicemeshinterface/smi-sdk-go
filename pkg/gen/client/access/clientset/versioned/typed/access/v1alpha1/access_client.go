...
func (c *AccessV1alpha1Client) ClusterTrafficTargets(namespace string) ClusterTrafficTargetInterface {
	return newClusterTrafficTargets(c, namespace)
}
