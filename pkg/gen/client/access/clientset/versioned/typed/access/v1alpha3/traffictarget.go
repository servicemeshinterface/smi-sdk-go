...
type TrafficTargetInterface interface {
	Create(ctx context.Context, trafficTarget *v1alpha3.TrafficTarget, opts v1.CreateOptions) (*v1alpha3.TrafficTarget, error)
	Update(ctx context.Context, trafficTarget *v1alpha3.TrafficTarget, opts v1.UpdateOptions) (*v1alpha3.TrafficTarget, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha3.TrafficTarget, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha3.TrafficTargetList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.TrafficTarget, err error)
...
func newTrafficTargets(c *AccessV1alpha3Client, namespace string) *trafficTargets {
...
func (c *trafficTargets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.TrafficTarget, err error) {
	result = &v1alpha3.TrafficTarget{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *trafficTargets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.TrafficTargetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha3.TrafficTargetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Create(ctx context.Context, trafficTarget *v1alpha3.TrafficTarget, opts v1.CreateOptions) (result *v1alpha3.TrafficTarget, err error) {
	result = &v1alpha3.TrafficTarget{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Update(ctx context.Context, trafficTarget *v1alpha3.TrafficTarget, opts v1.UpdateOptions) (result *v1alpha3.TrafficTarget, err error) {
	result = &v1alpha3.TrafficTarget{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("traffictargets").
...
func (c *trafficTargets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha3.TrafficTarget, err error) {
	result = &v1alpha3.TrafficTarget{}
